...
execute_process(
  COMMAND "/run/current-system/sw/bin/git" --git-dir=.git show-ref "origin/main"
  WORKING_DIRECTORY "/home/leeb/Projects/Nashi/build/_deps/sdl3-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/leeb/Projects/Nashi/build/_deps/sdl3-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/leeb/Projects/Nashi/build/_deps/sdl3-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
